...
execute if score #mobs diab.config matches 1 unless score #court.active diab.mob matches 1 if score @s diab.sin >= #court.imp_sin diab.mob run function diabolical:mobs/summon/contract_imp
