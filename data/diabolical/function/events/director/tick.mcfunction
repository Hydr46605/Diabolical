...
execute unless score #event.active diab.event matches 1 unless score #collector.active diab.event matches 1 unless score #collector.cooldown diab.event matches 1.. as @a[sort=random] if score @s diab.debt >= #collector.target_debt diab.event unless score #event.active diab.event matches 1 unless score #collector.active diab.event matches 1 run function diabolical:events/start/debt_collector
