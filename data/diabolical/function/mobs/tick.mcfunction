...
execute if score #court.active diab.mob matches 0 unless score #court.accuser_cd diab.mob matches 1.. as @a[scores={diab.sin=150..},limit=1,sort=random] run function diabolical:mobs/summon/the_accuser
execute if score #court.active diab.mob matches 0 unless score #court.bailiff_cd diab.mob matches 1.. as @a[scores={diab.debt=35..,diab.sin=25..},limit=1,sort=random] run function diabolical:mobs/summon/ledger_bailiff
execute if score #court.active diab.mob matches 0 unless score #court.wraith_cd diab.mob matches 1.. as @a[scores={diab.sin=75..},limit=1,sort=random] run function diabolical:mobs/summon/sin_wraith
execute if score #court.active diab.mob matches 0 unless score #court.imp_cd diab.mob matches 1.. as @a[scores={diab.sin=25..},limit=1,sort=random] run function diabolical:mobs/summon/contract_imp
