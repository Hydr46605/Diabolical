...
tellraw @s [{"text":"Relics: ","color":"gray"},{"score":{"name":"#relics","objective":"diab.config"},"color":"white"},{"text":"  Events: ","color":"gray"},{"score":{"name":"#events","objective":"diab.config"},"color":"white"}]
