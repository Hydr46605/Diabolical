...
data merge storage diabolical:config {version:"0.5.0-dev",debug:0b}
...
execute unless data storage diabolical:config profile_id run data merge storage diabolical:config {profile:"default",profile_id:1}
