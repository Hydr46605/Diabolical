...
execute if score @s diab.debt matches 50.. run tellraw @s [{"text":"Guidance: ","color":"gray"},{"text":"severe debt can attract collectors; pay down before the account is called.","color":"red"}]
