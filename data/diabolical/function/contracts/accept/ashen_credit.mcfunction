# Accepts Ashen Credit if the player can sign a contract.
...
execute if entity @s[tag=diab.contracts_unlocked,tag=!diab.contract_active] run function diabolical:contracts/accept/grant/ashen_credit
