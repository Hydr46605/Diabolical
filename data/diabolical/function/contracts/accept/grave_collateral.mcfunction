# Accepts Grave Collateral if the player can sign a major contract.
...
execute if entity @s[tag=diab.contracts_unlocked,tag=diab.contracts_major_unlocked,tag=!diab.contract_active] run function diabolical:contracts/accept/grant/grave_collateral
