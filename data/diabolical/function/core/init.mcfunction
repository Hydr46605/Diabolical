# Module bootstrap.
data merge storage diabolical:runtime {enabled:1b,version:"0.4.2-rc1",phase:24,heartbeat:{enabled:1b,interval:"1s"}}
...
function diabolical:config/profile/apply_current
