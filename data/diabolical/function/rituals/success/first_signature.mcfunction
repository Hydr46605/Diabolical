...
tellraw @a[distance=..8,limit=1,sort=nearest] [{"text":"[Diabolical] ","color":"dark_red"},{"text":"The ledger opens. Right-click the Infernal Ledger to choose a contract.","color":"gray"}]
